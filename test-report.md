...
This is an environment/toolchain failure, not evidence of a defect in the implementation or the test: ThreadSanitizer aborts at startup because the host exposes a 47-bit VMA range while this race runtime supports 48-bit VMA.
